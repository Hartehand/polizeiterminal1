...
function DDRPT.UI.BuildPeopleTab()
    ...
    DDRPT.UI.CreateLabel(searchPanel, "Name", 8, 2)
    local nameEntry = vgui.Create("DTextEntry", searchPanel)
    nameEntry:SetPos(8, 20)
