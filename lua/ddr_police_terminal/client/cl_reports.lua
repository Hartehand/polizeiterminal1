...
function DDRPT.UI.BuildReportsTab()
    ...
    buildLabel(filterPanel, "Status"):SetPos(8, 6)
    ...
    buildLabel(filterPanel, "Kategorie"):SetPos(160, 6)
    ...
    local filters = {
    status   = DDRPT.UI.GetComboValue(statusCombo),
    category = DDRPT.UI.GetComboValue(categoryCombo),
